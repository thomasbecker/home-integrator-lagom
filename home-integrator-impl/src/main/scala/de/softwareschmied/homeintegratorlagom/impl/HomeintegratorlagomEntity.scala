...
/**
  * This is an event sourced entity. It has a state, [[HomeintegratorlagomState]], which
  ...
  */
class HomeintegratorlagomEntity extends PersistentEntity {

  override type Command = HomeintegratorlagomCommand[_]
  override type Event = HomeintegratorlagomEvent
  override type State = HomeintegratorlagomState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: HomeintegratorlagomState = HomeintegratorlagomState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case HomeintegratorlagomState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        HomeintegratorlagomState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class GreetingMessageChanged(message: String) extends HomeintegratorlagomEvent
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends HomeintegratorlagomCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends HomeintegratorlagomCommand[String]
